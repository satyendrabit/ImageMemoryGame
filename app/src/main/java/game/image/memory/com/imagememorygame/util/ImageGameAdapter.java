 ...
 */
public class ImageGameAdapter extends RecyclerView.Adapter<ImageGameAdapter.MyviewHolder> {
    ...
    public ImageGameAdapter(Context context,HashMap<Integer,Bitmap> bitmapMap,ItemClickInterface clickInterface){
        super();
